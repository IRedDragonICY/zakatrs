...
void main() {
  ...
  testWidgets('Can calculate Business Zakat with ZakatManager', (
    WidgetTester tester,
  ) async {
    ...
    print(
      'Debug Business: IsPayable=${result.isPayable}, Due=${result.zakatDue.toDecimal()}, Threshold=${result.nisabThreshold.toDecimal()}',
    );
  ...
  testWidgets('Can calculate Savings Zakat with ZakatManager', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      const MaterialApp(home: Scaffold(body: Text("Test"))),
    ...
    print(
      'Debug Savings: IsPayable=${result.isPayable}, Due=${result.zakatDue.toDecimal()}',
    );
